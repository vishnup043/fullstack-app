        ...
        <div className='container'>
          <div className="flex justify-between">
            ...
            <div className="w-1/2 relative">
              ...
              <div
                className={`absolute top-12 right-0 h-full w-80 transform transition-transform duration-500 ease-in-out ${isOpen ? '' : 'opacity-0'
                  }`}
              >
                <div className="text-right">
                  <nav className=
                    {`grid grid-flow-row gap-4 text-lg ${isAfterSeconds ? "text-black" : "text-white"
                      }`}>
