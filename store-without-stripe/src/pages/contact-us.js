      ...
      <div className="relative pt-12">
              ...
              <div className="max-w-md mx-auto bg-green p-6 shadow-sm">
                <form className="space-y-5 bg-white p-8 relative z-10 rounded-2xl">
                  ...
                  <div className="pt-4">
                    <button
                      type="submit"
                      className="text-sm font-semibold py-2 rounded-md transition-all duration-200"
                    >
                      Submit
                    </button>
                  </div>
        ...
        <div className="absolute bottom-0 w-full">
          ...
          <div className="bg-green">
            <div className="container">
              <h1 className="text-[25vw] font-extrabold text-white/10 leading-none text-center pointer-events-none select-none">
                NEW LIFE
              </h1>
            </div>
          </div>
