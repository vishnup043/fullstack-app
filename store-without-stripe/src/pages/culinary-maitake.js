...
const CulinaryMaitake = () => {
  ...
  return (
    ...
    <div className="bg-limebg">
      ...
      <section className="culinary-maitake 2xl:mt-32 md:mt-24 mt-20 pb-16">
        <Image
        ...
        <div className="flex justify-center items-center mt-8">
          <Link href="/about" className="link-btn bg-greenLeaf text-white px-2 py-1 2xl:text-5xl lg:text-3xl text-2xl rounded-md">
            Expansion of our Facility
          </Link>
        </div>
        <div className="text-3xl flex w-[56px] text-white mx-auto mt-4">
