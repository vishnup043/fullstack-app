  ...
  return (
    ...
    <div>
      ...
      <div className="about-banner relative">
        <h1 className="text-greenLeaf text-[80px] text-center leading-[75px] pb-6">Black Maitake can keep your doctor away!</h1>
        <Image
        ...
        <div className="container">
          <div>
            ...
            <div className="w-max mx-auto">
              <Link href="/about" className="2xl:mt-24 xl:mt-20 block link-btn bg-greenLeaf text-white px-12 py-1 2xl:text-5xl lg:text-3xl text-2xl">
                ORDER NOW
              </Link>
              <div className="text-3xl flex w-[56px] text-green mx-auto mt-4">
