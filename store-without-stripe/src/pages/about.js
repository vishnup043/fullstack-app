    ...
    <div className="bg-white">
      ...
      <div className="about-banner relative">
        ...
        <Image
          ...
          alt="Banner"
          className="absolute maitake animate-spin transition ease-in-out duration-[s] cursor-not-allowed"
          width={400}
          height={400}
        />
      </div>
      <div className="container mx-auto text-center 2xl:pt-[135px] 2xl:pb-[110px] pt-[100px] pb-[80px] ">
        <h1 className="2xl:text-[80px] lg:text-6xl leading-none md:text-5xl text-4xl">Company profile & history</h1>
      ...
      <section className="2xl:pt-[256px] 2xl:pb-[160px] xl:pt-[100px] xl:pb-[60px] pt-[60px] pb-[40px]">
        <div className="container">
          ...
          <div className="text-3xl flex w-[56px] text-greenLeaf mx-auto mt-4">
